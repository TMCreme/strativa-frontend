...
import { ForgotPasswordFormData, validateForgotPassword } from '@/shared/validations';
...
export default function ForgotPasswordForm({ onSubmit, className = '', isLoading = false }: ForgotPasswordFormProps) {
