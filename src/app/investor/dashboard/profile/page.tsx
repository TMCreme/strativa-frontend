...
import {
  CompanyProfileContent as CompanyProfileComponent,
  ReviewDocumentsContent,
} from "@/features/Investor/components/dashboard";
...
function CompanyProfileContent() {
  ...
  const { companyProfile, isLoading, error, fetchCompanyProfile, clearError } =
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-6">
          ...
          <div className="flex flex-col gap-3 p-4 border border-gray-200 lg:border-r md:border-r-0">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {companyProfile.overview.revenue}
            </p>
          </div>
          <div className="flex flex-col gap-3 p-4 border border-gray-200 lg:border-r md:border-r-0">
            <Image
              src="/icons/analytics-02.png"
              alt="Dashboard"
              width={20}
              height={20}
            />
            ...
            <p className="text-2xl font-bold text-gray-900">
              {companyProfile.overview.reviews}
            </p>
          </div>
          <div className="flex flex-col gap-3 p-4 rounded-r-lg border border-gray-200">
            ...
            <div className="flex items-center space-x-1">
              <p className="text-2xl font-bold text-gray-900">
                {companyProfile.overview.rating}
              </p>
              <svg
      ...
      {/* Tab Content */}
      {activeTab === "profile" ? (
        <CompanyProfileComponent companyProfile={companyProfile} />
      ) : (
